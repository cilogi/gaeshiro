...
<div class="container">
    <div class="row">
        <div class="col-lg-4">
            ...
            <p>To sign in with an Email account choose Persona.</p>

            <p>You can also log in with Google or Facebook accounts. In each case we grab
               the Email address, but no registration is required.</p>

            <p>The Google login uses the built in AppEngine account service. Facebook uses OAuth</p>

             <p>Its straightforward to add other OAuth providers in addition to Facebook.
                Note that the token is invalidated as soon as we've read the Email address.
