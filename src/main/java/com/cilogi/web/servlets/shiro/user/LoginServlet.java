...
public class LoginServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            String password = WebUtils.getCleanParam(request, Names.PASSWORD);
            String username = WebUtils.getCleanParam(request, Names.USERNAME);
            boolean rememberMe = WebUtils.isTrue(request, Names.REMEMBER_ME);
