...
public class UserListServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            int iDisplayStart = intParameter(Names.DATATABLE_START, request, -1);
            int iDisplayLength = intParameter(Names.DATATABLE_LENGTH, request, -1);
            String sSearch = request.getParameter(Names.DATATABLE_SEARCH);
            String sEcho = request.getParameter(Names.DATATABLE_ECHO);
